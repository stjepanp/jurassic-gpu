...
typedef struct {
  ...
  int sca_mult; //TODO: new!

  /* Extinction coefficient type if sca_mult=0 */
  char sca_ext[LEN]; //TODO: new!
  ...
  double retnn_zmin; //TODO: new!
  
  /* Maximum altitude for particle retrieval [km]. */
  double retnn_zmax; //TODO: new!
...
/* 
  TODO: pos_t, Point on the Line-of-sight data without storing!!!
               +some additional curtis_gudson variables..
*/
...
typedef struct {
  //TODO: be careful about index perumations
  
  /* Number of pressure levels. */
  int np[NGMAX][NDMAX]; 
  
  /* Number of temperatures. */
  int nt[NGMAX][NDMAX][TBLNPMAX]; //TODO: nt[NG][TBLNP][ND]
  
  /* Number of column densities. */
  int nu[NGMAX][NDMAX][TBLNPMAX][TBLNTMAX]; // TODO: nu[NG][TBLNP][TBLNT][ND]
  
  /* Pressure [hPa]. */
  double p[NGMAX][NDMAX][TBLNPMAX]; //TODO: p[NG][TBLNP][ND]
  
  /* Temperature [K]. */
  double t[NGMAX][NDMAX][TBLNPMAX][TBLNTMAX]; //TODO: t[NG][TBLNP][TBLNT][ND]
  
  /* Column density [molecules/cm^2]. */
  float u[NGMAX][NDMAX][TBLNPMAX][TBLNTMAX][TBLNUMAX]; 
        //TODO: real_tblND_t u[NG][TBLNP][TBLNT][TBLNU][ND]
  
  /* Emissivity. */
  float eps[NGMAX][NDMAX][TBLNPMAX][TBLNTMAX][TBLNUMAX];
        //TODO: real_tblND_t eps[NG][TBLNP][TBLNT][TBLNU][ND] 

  /* Source function temperature [K]. */
  double st[TBLNSMAX];
  
  /* Source function radiance [W/(m^2 sr cm^-1)]. */
  double sr[NDMAX][TBLNSMAX]; //TODO: sr[TBLNS][ND];
